...
class Frame(object):
    ...
    def make_child_frame(self, formals, vals):
        ...
        cur1, cur2 = formals, vals
        while cur1 != nil and cur2 != nil:
            new_frame.define(cur1.first, cur2.first)
            cur1, cur2 = cur1.rest, cur2.rest
        if cur1 != nil or cur2 != nil:
            raise SchemeError
        return new_frame
        # END PROBLEM 10
...
def make_let_frame(bindings, env):
    ...
    while cur != nil:
        ...
        values = Pair(scheme_eval(cur.first.rest.first, env), values)
        cur = cur.rest
